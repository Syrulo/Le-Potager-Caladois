 ...
 */
final class Version20240515142452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur_details (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, prenom VARCHAR(150) DEFAULT NULL, nom VARCHAR(150) DEFAULT NULL, tel VARCHAR(10) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_82DFC18F037AB0F (tel), UNIQUE INDEX UNIQ_82DFC18FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
